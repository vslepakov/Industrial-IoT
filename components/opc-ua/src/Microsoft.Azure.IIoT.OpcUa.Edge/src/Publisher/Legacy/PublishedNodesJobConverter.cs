...
namespace Microsoft.Azure.IIoT.OpcUa.Edge.Publisher.Models {
    ...
    public class PublishedNodesJobConverter {
        ...
        /// <returns></returns>
        public IEnumerable<WriterGroupModel> Read(TextReader publishedNodesFile,
        ...
        /// <param name="legacyCliModel">The legacy command line arguments</param>
        /// <returns></returns>
        private IEnumerable<WriterGroupModel> ToWriterGroupJobs(
            ...
            try {
                return items
                    ...
                    .Select(dataSetSourceBatches => new WriterGroupModel {
                        ...
                        PublishingInterval = _config.BatchTriggerInterval,
                        BatchSize = _config.BatchSize,
                        MaxNetworkMessageSize = _config.MaxMessageSize,
                        WriterGroupId = $"{dataSetSourceBatches.First().Connection.Endpoint.Url}_" +
                            $"{dataSetSourceBatches.First().GetHashSafe()}",
                        DataSetWriters = dataSetSourceBatches
