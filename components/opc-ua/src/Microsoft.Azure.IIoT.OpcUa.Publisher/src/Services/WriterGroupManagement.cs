...
namespace Microsoft.Azure.IIoT.OpcUa.Publisher.Services {
    ...
    /// </summary>
    public sealed class WriterGroupManagement : IDataSetBatchOperations, IDataSetWriterRegistry,
        IDataSetWriterStateUpdate, IWriterGroupRegistry, IWriterGroupStateUpdate {
