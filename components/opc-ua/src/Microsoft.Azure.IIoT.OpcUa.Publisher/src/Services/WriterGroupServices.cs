...
namespace Microsoft.Azure.IIoT.OpcUa.Publisher.Services {
    ...
    /// </summary>
    public sealed class WriterGroupServices : IDataSetBatchOperations,
        ...
        public WriterGroupServices(IDataSetEntityRepository dataSets, IEndpointRegistry endpoints,
