...
namespace Microsoft.Azure.IIoT.OpcUa.Publisher.Services {
    ...
    /// Publisher client
    /// </summary>
    public sealed class PublisherJobService : IPublishServices {
        ...
        public async Task<PublishStartResultModel> NodePublishStartAsync(
            ...
            var result = await _jobs.NewOrUpdateJobAsync(GetDefaultId(endpointId), job => {
                ...
                job.JobConfiguration = publishJob;
        ...
        public async Task<PublishedNodeListModel> NodePublishListAsync(
            ...
            List<PublishedNodeModel> list = null;
            var result = await _jobs.NewOrUpdateJobAsync(GetDefaultId(endpointId), job => {
                var publishJob = AsJob(job);
                list = publishJob.WriterGroup.DataSetWriters
                    ...
                    .SelectMany(source => source.PublishedVariables.PublishedData
                        .Select(variable => new PublishedNodeModel {
        ...
        private void AddOrUpdateItemInJob(WriterGroupJobModel publishJob,
            PublishedNodeModel publishedItem, string endpointId, string publisherId,
